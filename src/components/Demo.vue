...
<body>
  ...
  <header class="page-header">
    <div class="branding">
      ...
      <h1>Vue.js 2 CRUD</h1>
      <p>Ported from: <a href="">Vue.js CRUD application</a></p>
    </div>
  </header>
  <main id="app">
    ...
    <table class="table">
      ...
      <tr v-for="product in filteredProducts">
        ...
        <td>
          ...
          <router-link class="btn btn-danger btn-xs" v-bind:to="{name: 'product-delete', params: {product_id: product.id}}">Esborrar</router-link>
        </td>
      </tr>
      </tbody>
    </table>
...
var products = [
  {id: 1, name: 'Telefon', description: 'Movil Android', price: 500},
  {id: 2, name: 'Tablet', description: 'Apple', price: 100},
  {id: 3, name: 'Coche', description: 'Opel Astra', price: 2000}
];

function findProduct (productId) {
    return products[findProductKey(productId) {
      for (var key=0; key < products.lenght;
      key++) {
        if (products[key].id == prductId){
          return key;
        }
      }
    };
...
var List = Vue.extend({
  ...
  computed: {
    filterProducts: function () {
      return this.products.filter(function
      (product))
